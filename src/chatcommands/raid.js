...
const raid = (data, message) => {
	...
	*/
	reply = data.getEmoji(boss) + bossTag + legendaryTag + ' raid reported to ' + data.channelsByName['gymraids_alerts'] + ' (ending: ' + twelveHrDate + ') at ' + '**' + detail + '**' + specialRaidTag + ' added by ' + message.member.displayName;
	message.channel.send(reply);
